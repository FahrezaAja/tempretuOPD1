...
@section('content')
    <div class="max-w-2xl mx-auto p-6">
        <h1 class="text-2xl font-bold mb-4">Edit Admin: {{ $admin->username }}</h1>
        ...
        <form action="{{ route('super.admin.update', $admin->id) }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="username" class="w-full border px-3 py-2"
            ...
            <button type="submit" class="bg-blue-500 text-white px-4 py-2 rounded">Update Admin</button>
