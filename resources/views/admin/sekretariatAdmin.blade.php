    ...
    <div class="max-w-6xl mx-auto p-6">
        ...
        @if($sekretariat)
            ...
            <div class="bg-white rounded-xl shadow-lg p-6 mb-8 transition transform hover:scale-[1.01]">
                ...
                <form action="{{ route('sekretariatAdmin.update', $sekretariat->id) }}" method="POST"
            ...
            <div class="bg-red-50 rounded-xl shadow-lg p-6 transition transform hover:scale-[1.01]">
                ...
                <form action="{{ route('sekretariatAdmin.destroy', $sekretariat->id) }}" method="POST"
                    onsubmit="return confirm('Yakin ingin menghapus Sekretariat?');">
                    @csrf
                    @method('DELETE')
                    <button type="submit"
        ...
        @else
            ...
            <div class="bg-white rounded-xl shadow-lg p-6 transition transform hover:scale-[1.01]">
                ...
                <form action="{{ route('sekretariatAdmin.store') }}" method="POST" enctype="multipart/form-data"
                    class="space-y-5">
                    @csrf
