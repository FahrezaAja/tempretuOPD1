...
<div class="max-w-6xl mx-auto p-6">
    ...
    <div class="bg-white rounded-xl shadow-lg p-6 mb-8 transition transform hover:scale-[1.01]">
        ...
        <form action="{{ route('profilOPDAdmin.update', $profilopd->id) }}" method="POST" enctype="multipart/form-data" class="space-y-5">
            @csrf
            @method('PUT')
    ...
    <div class="bg-red-50 rounded-xl shadow-lg p-6 transition transform hover:scale-[1.01]">
        ...
        <form action="{{ route('profilOPDAdmin.destroy', $profilopd->id) }}" method="POST" onsubmit="return confirm('Yakin ingin menghapus Profil OPD?');">
            @csrf
            @method('DELETE')
            <button type="submit"
    ...
    <div class="bg-white rounded-xl shadow-lg p-6 transition transform hover:scale-[1.01]">
        ...
        <form action="{{ route('profilOPDAdmin.store') }}" method="POST" enctype="multipart/form-data" class="space-y-5">
            @csrf
