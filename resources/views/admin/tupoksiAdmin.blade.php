    ...
    <div class="max-w-6xl mx-auto p-6">
        ...
        @if($tupoksi)
            ...
            <div class="bg-white rounded-xl shadow-lg p-6 mb-8 transition transform hover:scale-[1.01]">
                ...
                <form action="{{ route('tupoksiAdmin.update', $tupoksi->id) }}" method="POST" enctype="multipart/form-data"
                    class="space-y-5">
                    @csrf
                    @method('PUT')
            ...
            <div class="bg-red-50 rounded-xl shadow-lg p-6 transition transform hover:scale-[1.01]">
                ...
                <form action="{{ route('tupoksiAdmin.destroy', $tupoksi->id) }}" method="POST"
                    onsubmit="return confirm('Yakin ingin menghapus Tupoksi?');">
                    @csrf
                    @method('DELETE')
                    <button type="submit"
