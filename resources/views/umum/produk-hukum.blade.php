...
<section x-data="{ view: 'table', documents: [
    { penulis: 'Admin', nomor: '001', tahun: '2025', nama: 'Rencana Kerja 2025', kategori: 'Strategis', tanggal: '2025-01-10', file: 'rencana-kerja-2025.pdf' },
    { penulis: 'Sekretariat', nomor: '002', tahun: '2024', nama: 'Laporan Kegiatan 2024', kategori: 'Laporan', tanggal: '2025-02-15', file: 'laporan-2024.pdf' },
    { penulis: 'Tim Teknis', nomor: '003', tahun: '2025', nama: 'Program Digitalisasi', kategori: 'Program', tanggal: '2025-03-05', file: 'program-digitalisasi.pdf' }
            ...
            <table class="min-w-full divide-y divide-gray-200">
                <thead class="bg-indigo-700 text-white sticky top-0 z-10">
                    <tr>
                        ...
                        <th class="px-6 py-3 text-left text-sm font-semibold">Nomor</th>
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    <template x-for="doc in documents" :key="doc.file">
                        <tr class="hover:bg-indigo-50 transition-colors">
                            ...
                            <td class="px-6 py-4 text-gray-700" x-text="doc.nomor"></td>
                            <td class="px-6 py-4 text-gray-700" x-text="doc.tahun"></td>
            ...
            <template x-for="doc in documents" :key="doc.file">
                <div class="bg-white shadow-xl rounded-2xl p-6 flex flex-col justify-between transition-transform hover:scale-[1.02]">
                    <div>
                        ...
                        <p class="text-gray-700 mb-1"><span class="font-semibold">Nomor:</span> <span x-text="doc.nomor"></span></p>
                        <p class="text-gray-700 mb-1"><span class="font-semibold">Tahun:</span> <span x-text="doc.tahun"></span></p>
                        <p class="text-gray-700 mb-1"><span class="font-semibold">Kategori:</span> <span x-text="doc.kategori"></span></p>
                        <p class="text-gray-700 mb-1"><span class="font-semibold">Tanggal:</span> <span x-text="doc.tanggal"></span></p>
                    </div>
                    <div class="mt-2">
                        <a :href="`/files/${doc.file}`" target="_blank" 
