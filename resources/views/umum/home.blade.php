...
<section x-data="heroSection()" x-init="init()"
    ...
    <div class="relative z-30 flex flex-col-reverse md:flex-row items-center justify-between w-full px-6 sm:px-10 lg:px-24 text-white">
        ...
        <div :class="mobile ? 'opacity-0 transition-opacity duration-700 fade-in' : ''"
            ...
            :style="desktop ? 'transform: translateX(' + textOffset + 'px);' : ''">
...
<section x-data="sectionTwo()" x-init="init()"
    ...
    <div :class="mobile ? 'opacity-0 transition-opacity duration-700 fade-in' : ''"
        ...
        :style="desktop ? 'transform: translateX(' + imageOffset + 'px);' : ''">
        ...
        init() {
            ...
            if(this.desktop){
                window.addEventListener('scroll', () => {
                    ...
                    this.textOffset = -scrollPos * 0.85;
                    this.imageOffset = scrollPos * 0.85;
                });
            } else {
                // fade in di mobile
                setTimeout(() => {
