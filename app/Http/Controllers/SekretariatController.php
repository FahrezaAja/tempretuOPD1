...
class SekretariatController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin.sekretariatAdmin')->with('success', 'Tugas pokok & fungsi sekretariat berhasil ditambahkan.');
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        return redirect()->route('admin.sekretariatAdmin')->with('success', 'Tugas pokok & fungsi Sekretariat berhasil diperbarui.');
    }
    ...
    public function destroy(string $id)
    {
        ...
        return redirect()->route('admin.sekretariatAdmin')->with('success', 'Tugas pokok & fungsi sekretariat berhasil dihapus.');
    }
}
